...
public class SearchEmployeeController extends WorkspaceController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        EmployeeInforRepositoryImpl employeeInforRepositoryImpl = new EmployeeInforRepositoryImpl();
        employeeObservableList = employeeInforRepositoryImpl.getAllEmployeeInfo();
    ...
    void onSearchEmplyee(ActionEvent event) {
        if(ID_Employee!=null){
            try {
                ...
                changeWorkspace("/project/itss/group11/itss/view/manager/OverviewEmployee.fxml");
            }catch (Exception e){
                ...
                button.setOnAction(event -> {
                    ...
                    // Lấy đối tượng Stage hiện tại
                        try {
                            ...
                            changeWorkspace("/project/itss/group11/itss/view/OverviewEmployee.fxml");
                        } catch (IOException e) {
